...
create table public.invoice (
	...
	version bigint,
	constraint fk_invoice_payment_settings foreign key (payment_settings_id) references public.payment_settings(id),
	primary key (id)
);
...
create unique index uk_invoice_payment_settings_id on public.invoice (payment_settings_id);
...
create table public.invoice_line_item (
	...
	name varchar(255),
	amount numeric(38,2),
	constraint fk_invoice_line_item_invoice foreign key (invoice_id) references public.invoice(id)
);
